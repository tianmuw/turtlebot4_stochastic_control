...
class NavActionClientNode(Node):
    def __init__(self, name):
        super().__init__(name)
        self._action_client = ActionClient(                     # Create action client (action_type, action_name)
    ...
    def feedback_callback(self, feedback_msg):
        ...
        self.get_logger().info(f'Current navigate state: {feedback.navigate_state}, remaining angle travel is {feedback.remaining_angle_travel}, and remaining travel distance is {feedback.remaining_travel_distance}')
